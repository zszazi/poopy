class NumberNode:
    """
    Will take in corresponding number token either INT or FLOAT
    """
...
class BinOpNode:
    """
    for addition, sub, multiple and divide operation
    """
...
class UnaryOpNode:
    """
    For uniary operations like negative or postive of a number
    """
